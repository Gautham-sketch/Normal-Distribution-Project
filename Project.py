...
std1 = len(thin_1_std_deviation)*100/len(data)
std2 = len(thin_1_std_deviation)*100/len(data)
std3 = len(thin_1_std_deviation)*100/len(data)

print("{} percentage of data lies in the range".format(std1))
print("{} percentage of data lies in the range".format(std2))
print("{} percentage of data lies in the range".format(std2))